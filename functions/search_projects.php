...
function search_projects($query_words)
{
    ...
    $search_query = "SELECT P.name AS 'project_name', P.id AS 'project_id', I.id AS 'img_id' FROM projects AS P, images AS I WHERE P.id = I.projects_id AND MATCH(P.name, P.keywords, I.alt) AGAINST (:query_words);";
